        ...
        <div className="white  w-full ">
            ...
            <div className="relative h-[700px] text-white">
                <div className="flex justify-center items-center absolute w-full h-full bg-black bg-opacity-50 top-0 left-0 z-10">
                    <div  className="shadow-2xl py-20 w-[1200px] backdrop-blur-lg bg-black bg-opacity-25 rounded-[80px]">
                        <h1 className="leading-[3.5rem] px-40 text-center text-5xl font-bold">Explore and make your dreams come true with our SeaHotel</h1>
                        <p className="px-80 mt-8 text-center">There are many variations of the passages of lorem Ipsum fromavailable,variations of the passages.</p>
            ...
            <div className="mt-32 w-full flex  justify-center">
                <div className="max-w-[1200px] flex gap-10"> 
                    <img className="w-full h-full  lg:h-[600px]" src={ImgCard} alt="" />
                    <div className="w-full flex items-center">
                        <div className="">
                            <p className=" text-xl"> About us </p>
                            <h2 className=" mt-2 text-4xl font-bold capitalize"> We invite guests to celebrate and enjoy a life of luxury </h2>
            ...
            <div className="bg-black w-full h-96 mt-32 text-white flex justify-center items-center">
                <div className="max-w-[1200px]  flex gap-8 ">
                    <div className=" border-r-2 border-white px-20 ">
                    ...
                    <div className=" border-white px-20">
            ...
            <div className="mt-32 flex justify-center">
                <div className="max-w-[1200px] ">
                    ...
                    <h1 className="text-4xl text-center font-bold">Read our blog and news</h1>
                    <p className="text-gray-500 mt-8 text-center px-60">Savvy travelers are looking for more than just the next destination on the map. They are looking for a memorable experience and to make new friends along the way.</p>
